...
contains
  subroutine initnudge
    ...
    allocate(thlnudge3D(itot,jtot,kmax,ntnudge3D),qtnudge3D(itot,jtot,kmax,ntnudge3D)) !MS: allocate 3D nudging arrays (with fluctuations)
    ...
    call D_MPI_BCAST(thlnudge3D,itot*jtot*kmax*ntnudge3D,0,comm3d,mpierr)
    call D_MPI_BCAST(qtnudge3D ,itot*jtot*kmax*ntnudge3D,0,comm3d,mpierr)
